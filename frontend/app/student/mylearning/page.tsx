...
export default function StudentCourses() {
  ...
  return (
    <div className="space-y-8">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500">{studentInfo.currentSemester}</div>
            </div>
          </div>
      ...
      {/* Courses Tabs */}
      <CardContent>
      <Tabs defaultValue="current" className="w-full mx-2">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="current">
            Khóa học đang học ({currentCourses.length})
          </TabsTrigger>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="text-sm space-y-1">
                      ...
                      <p className="flex items-center gap-1 text-blue-600">
                        ...
                        Buổi học tiếp theo: {new Date(course.nextClass).toLocaleString('vi-VN')}
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-gray-600">Thông báo</div>
                      </div>
                    </div>

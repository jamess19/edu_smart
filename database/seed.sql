...
INSERT INTO Department (department_id, department_name, department_code, description) VALUES
(1, 'Khoa Công nghệ Thông tin', 'CNTT', 'Khoa đào tạo về công nghệ thông tin và phần mềm'),
(2, 'Khoa Kinh tế', 'KT', 'Khoa đào tạo về kinh tế và quản trị kinh doanh'),
(3, 'Khoa Ngoại ngữ', 'NN', 'Khoa đào tạo các ngôn ngữ quốc tế'),
(4, 'Khoa Cơ khí', 'CK', 'Khoa đào tạo về kỹ thuật cơ khí và chế tạo máy'),
(5, 'Khoa Điện - Điện tử', 'DDT', 'Khoa đào tạo về kỹ thuật điện và điện tử');
...
UPDATE Department SET manager_id = 6 WHERE department_id = 4;
UPDATE Department SET manager_id = 7 WHERE department_id = 5;
...
INSERT INTO OpenCourses (opencourse_id, course_id, max_student, term, year, registration_start, registration_end) VALUES
...
INSERT INTO TeachingAssignment (assignment_id, opencourse_id, teacher_id, created_at) VALUES
...
-- Insert Enrollment
INSERT INTO Enrollment (enrollment_id, opencourse_id, student_id, enrolled_at, status, theoretical_point, practical_point, midterm_point, endterm_point, final_point) VALUES
-- Lập trình căn bản
...
UNION ALL
SELECT 'TeachingAssignment', COUNT(*) FROM TeachingAssignment
UNION ALL
